...
function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand('extension.aesopAwaken', () => {
        ...
        panel.webview.html = `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Aesop</title></head><body><iframe></iframe><span>Let's put some content here</span></body></html>`;
